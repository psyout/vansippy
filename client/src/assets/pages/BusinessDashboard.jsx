      ...
      <div className="business-dashboard-container">
         <header className="business-dashboard-header">
            ...
            <div className="header-actions">
               <button onClick={handleEditBusiness} className="btn-primary">
                  Edit Business
               </button>
         ...
         <div className="dashboard-content">
            <div className="business-overview">
               ...
               <div className="overview-card">
                  <h3>Drinks Menu</h3>
                  {business.drinks &&
                  Object.keys(business.drinks).length > 0 ? (
                     <div className="menu-list">
                        {Object.entries(business.drinks).map(
                           ([name, price]) => (
                  ...
                  <div className="stats-grid">
                     <div className="stat-item">
                        <span className="stat-number">
                           {business.hours
                              ? Object.keys(business.hours).length
                              : 0}
                        </span>
                     ...
                     <div className="stat-item">
                        <span className="stat-number">
                           {business.drinks
                              ? Object.keys(business.drinks).length
                              : 0}
                        </span>
                     ...
                     <div className="stat-item">
                        <span className="stat-number">
                           {business.food
                              ? Object.keys(business.food).length
                              : 0}
                        </span>
